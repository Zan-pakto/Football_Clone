...
export class CacheService {
  ...
  /**
   * Revalidate Next.js cache path (No-op on Express backend)
   */
  revalidateNextPath(_path: string): void {
    // No-op on Express backend
  }

  /**
   * Revalidate Next.js cache tag (No-op on Express backend)
   */
  revalidateNextTag(_tag: string): void {
    // No-op on Express backend
  }
