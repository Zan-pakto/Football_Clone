/**
 * Country Flag Resolver Utility
 * Resolves local flags stored in /flags/{slug}.png with smart aliases and fallback to FlagCDN
 */
...
/**
 * Returns the URL path to the country flag image.
 * Prefers local /flags/{slug}.png which are pre-stored in public/flags.
 */
